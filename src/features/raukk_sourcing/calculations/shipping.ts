...
export function calculatePairShipping(
	...
	legs.forEach((leg) => {
		...
		costed.push({
			...
			weightOutPerDay: leg.loadOut.weightPerDay,
			volumeOutPerDay: leg.loadOut.volumePerDay,
			weightBackPerDay: leg.loadBack.weightPerDay,
			volumeBackPerDay: leg.loadBack.volumePerDay,
			dailyCost: legDailyCost,
			roundTripMinutes,
			shippingFraction: legFraction,
