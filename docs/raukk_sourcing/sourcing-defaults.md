...
8. **A third aggregate**, selectable per ticker like `AGG_AVG` and
...
9. **The denominator is the WHOLE demand**, this plans need plus every
...
10. **The full need stays booked as a draw.** The pool is oversubscribed
...
11. **Known simplification, accepted**: because the whole need is
    ...
    is exact.
12. **The market half is the CX preference price** of the consuming
